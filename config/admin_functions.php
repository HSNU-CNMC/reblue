...
function pagelines_save()
{
	...
	if($_POST['pagelines_form'] == "feature_form"){
		$setup_page = 'admin.php?page=reblue_feature';
		...
		$setup_page = 'admin.php?page=reblue';
		...
		<table id="optionstable"><tbody><tr><td valign="top" width="100%">
		  ...
		  <form method="post" action="<?php echo admin_url('admin-post.php?action=pagelines_save'); ?>">
				 ...
				 <!-- hidden fields -->
					...
					<?php if ( isset($_GET['pageaction']) && $_GET['pageaction']):?>
				...
				<script type="text/javascript">
						...
						<div id="optionsheader">
							...
							<div id="optionstop" class="fix">
								...
								<a class="optionsheader_plink" href="http://cnmc.tw" target="_blank">&nbsp;</a>
							</div>
...
<div class="optionrow fix <?php if(isset($option_atts['layout']) && $option_atts['layout']=='full') echo 'wideinputs';?>">
	...
	<div class="theinputs " <?php if ( $optiontype == 'image_url' || $optiontype == 'text_long' || $optiontype == 'textarea_big') echo 'style=" width: 100% ;"'; ?>>
		<div class="optioninputs">
			
		<?php if($optiontype == 'image_url'):?>
			<p>	<label class="context" for="<?php echo $optionname;?>">完整的圖片 URL</label><br/>
		...
		<?php if($option_exp && $optiontype != 'text_content' && $optiontype != 'text_long' && $optiontype != 'image_url' && $optiontype != 'textarea_big' ):?>
		<div class="theexplanation">
			<div class="context">說明</div>
